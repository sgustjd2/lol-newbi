...
- 챔피언 상세 팝업에는 16.18 LoLalytics 기준 대표 카운터 3개를 보여줍니다. 카운터 아이콘을 누르면 해당 챔피언의 실제 스킬 상호작용을 바탕으로 한 초보자용 한 줄 이유가 펼쳐집니다. 역할·티어·표본에 따라 달라지는 참고 정보입니다. 이유 문구를 다시 생성할 때는 `npm run enrich:counters`를 사용합니다.
