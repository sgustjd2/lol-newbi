...
- `봇 듀오` 탭에 `data/bot-duos.json`의 2026 시즌 공개 프로 대회 경기 2,057건에서 1경기 이상 나온 411개 조합이 있다. S+·S·A·B·C 티어순으로 정렬하고 조합별 카운터 2개와 초보자용 궁합·운영 설명을 보여준다. 현재 수집 범위는 16.01–16.17이며 통계는 패치·지역·티어·표본에 따라 달라지는 참고 자료다.
